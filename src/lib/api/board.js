...
// checklist
export const createCheckList = ({ boardId, card_id, data }) =>
	client.post('/board/' + boardId + '/card/' + card_id + '/checklist', data);
export const deleteCheckList = ({ boardId, card_id, checklist_id }) =>
	client.delete('/board/' + boardId + '/card/' + card_id + '/checklist/' + checklist_id);
export const getCheckList = ({ boardId, card_id }) => client.get('/board/' + boardId + '/card/' + card_id + '/checklist');

// checklist item
export const createCheckListItem = ({ boardId, checklist_id, data }) =>
	client.post('/board/' + boardId + '/checklist/' + checklist_id, data);
export const updateCheckListItem = ({ boardId, item_id, data }) =>
	client.put('/board/' + boardId + '/checklist_item/' + item_id, data);
export const deleteCheckListItem = ({ boardId, item_id }) => client.delete('/board/' + boardId + '/checklist_item/' + item_id);

// comment
export const createComment = ({ boardId, card_id, data }) =>
	client.post('/board/' + boardId + '/card/' + card_id + '/comment', data);
...
export const updateCardLabel = ({ boardId, card_id, label_id, data }) =>
	client.put('/board/' + boardId + '/card/' + card_id + '/labels/' + label_id, data);
